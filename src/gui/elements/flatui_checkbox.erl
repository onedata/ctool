...
render_element(Record) ->
    Id = case Record#flatui_checkbox.id of undefined -> wf:temp_id(); I -> I end,
    case Record#flatui_checkbox.postback of
        undefined -> ignore;
        Postback ->
            wf:wire(#event{type = change, postback = Postback, target = Id, source = Record#flatui_checkbox.source, delegate = Record#flatui_checkbox.delegate})
    end,
    Label = [wf_tags:emit_tag(<<"input">>, [], [
        % global
        {<<"accesskey">>, Record#flatui_checkbox.accesskey},
        {<<"class">>, Record#flatui_checkbox.class},
        {<<"contenteditable">>, case Record#flatui_checkbox.contenteditable of true -> "true"; false -> "false"; _ ->
            undefined end},
        {<<"contextmenu">>, Record#flatui_checkbox.contextmenu},
        {<<"dir">>, case Record#flatui_checkbox.dir of "ltr" -> "ltr"; "rtl" -> "rtl"; "auto" -> "auto"; _ ->
            undefined end},
        {<<"draggable">>, case Record#flatui_checkbox.draggable of true -> "true"; false -> "false"; _ ->
            undefined end},
        {<<"dropzone">>, Record#flatui_checkbox.dropzone},
        {<<"hidden">>, case Record#flatui_checkbox.hidden of "hidden" -> "hidden"; _ -> undefined end},
        {<<"id">>, Id},
        {<<"lang">>, Record#flatui_checkbox.lang},
        {<<"spellcheck">>, case Record#flatui_checkbox.spellcheck of true -> "true"; false -> "false"; _ ->
            undefined end},
        {<<"style">>, Record#flatui_checkbox.style},
        {<<"tabindex">>, Record#flatui_checkbox.tabindex},
        {<<"title">>, Record#flatui_checkbox.title},
        {<<"translate">>, case Record#flatui_checkbox.contenteditable of "yes" -> "yes"; "no" -> "no"; _ ->
            undefined end},
        % spec
        {<<"autofocus">>, Record#flatui_checkbox.autofocus},
        {<<"checked">>, if Record#flatui_checkbox.checked == true -> <<"checked">>; true -> undefined end},
        {<<"data-toggle">>, <<"checkbox">>},
        {<<"disabled">>, if Record#flatui_checkbox.disabled == true -> "disabled"; true -> undefined end},
        {<<"form">>, Record#flatui_checkbox.form},
        {<<"name">>, Record#flatui_checkbox.name},
        {<<"required">>, if Record#flatui_checkbox.required == true -> "required"; true -> undefined end},
        {<<"type">>, <<"checkbox">>},

...
%%%-------------------------------------------------------------------
%%% @doc
%%% Module implementing the dataset data type used in automation machinery.
%%% @end
%%%-------------------------------------------------------------------
-module(atm_dataset_type).
-author("Lukasz Opiola").
...
is_instance(#{<<"datasetId">> := DatasetId}) when is_binary(DatasetId) -> true;

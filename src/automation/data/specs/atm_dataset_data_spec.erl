...
%%%-------------------------------------------------------------------
%%% @doc
%%% Module implementing the dataset data spec used in automation machinery.
%%% @end
%%%-------------------------------------------------------------------
-module(atm_dataset_data_spec).
-author("Lukasz Opiola").
...
-type record() :: #atm_dataset_data_spec{}.
...
db_encode(#atm_dataset_data_spec{}, _NestedRecordEncoder) ->
    #{}.

...
%%%-------------------------------------------------------------------
%%% @doc
%%% Module implementing the object data spec used in automation machinery.
%%% @end
%%%-------------------------------------------------------------------
-module(atm_object_data_spec).
-author("Lukasz Opiola").
...
-type record() :: #atm_object_data_spec{}.
...
db_encode(#atm_object_data_spec{}, _NestedRecordEncoder) ->
    #{}.

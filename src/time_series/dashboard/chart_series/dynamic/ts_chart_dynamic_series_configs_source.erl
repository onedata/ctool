...
%%%-------------------------------------------------------------------
%%% @doc
%%% Record expressing a definition of a source for external series configs
%%% of a time series.
%%% @end
%%%-------------------------------------------------------------------
-module(ts_chart_dynamic_series_configs_source).
-author("Lukasz Opiola").
...
-type record() :: #ts_chart_dynamic_series_configs_source{}.
...
encode_with(Record, NestedEncoder) ->
    #{
        <<"sourceType">> => time_series:dynamic_source_type_to_json(Record#ts_chart_dynamic_series_configs_source.source_type),
        <<"sourceSpec">> => NestedEncoder(
            Record#ts_chart_dynamic_series_configs_source.source_spec,

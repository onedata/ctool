...
%%%-------------------------------------------------------------------
%%% @doc
%%% Record expressing a recipe for a static chart series builder.
%%% @end
%%%-------------------------------------------------------------------
-module(ts_chart_static_series_builder_recipe).
-author("Lukasz Opiola").
...
-type record() :: #ts_chart_static_series_builder_recipe{}.
...
encode_with(Record, NestedEncoder) ->
    #{
        <<"seriesTemplate">> => NestedEncoder(
            Record#ts_chart_static_series_builder_recipe.series_template,

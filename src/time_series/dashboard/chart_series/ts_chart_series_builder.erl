...
%%%-------------------------------------------------------------------
%%% @doc
%%% Record expressing a series builder for time series charts.
%%% @end
%%%-------------------------------------------------------------------
-module(ts_chart_series_builder).
-author("Lukasz Opiola").
...
-type record() :: #ts_chart_series_builder{}.
...
type_to_recipe_type(static) -> ts_chart_static_series_builder_recipe;
type_to_recipe_type(dynamic) -> ts_chart_dynamic_series_builder_recipe.

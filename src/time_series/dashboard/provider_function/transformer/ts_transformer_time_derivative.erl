...
%%% the "timeDerivative" transformer that calculates the speed of changes
%%% between consecutive input values.
%%% @end
%%%-------------------------------------------------------------------
-module(ts_transformer_time_derivative).
-author("Lukasz Opiola").
...
-type record() :: #ts_transformer_time_derivative{}.

...
%%% the "abs" transformer that returns the absolute value of the input value.
%%% @end
%%%-------------------------------------------------------------------
-module(ts_transformer_abs).
-author("Lukasz Opiola").
...
-type record() :: #ts_transformer_abs{}.
...
encode_with(Record, NestedRecordEncoder) ->
    #{
        <<"inputDataProvider">> => NestedRecordEncoder(Record#ts_transformer_abs.input_data_provider, ts_provider_function)
    }.

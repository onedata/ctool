...
serialize_type('*', regular) -> throw(?new_ERROR_BAD_GRI());
...
deserialize_type(_, _) -> throw(?new_ERROR_BAD_GRI()).
...
serialize_id(<<"*">>, regular) -> throw(?new_ERROR_BAD_GRI());
...
deserialize_id(<<"*">>, regular) -> throw(?new_ERROR_BAD_GRI());
...
deserialize_aspect([_, <<"*">>], regular) -> throw(?new_ERROR_BAD_GRI());
deserialize_aspect([<<"*">>, _], regular) -> throw(?new_ERROR_BAD_GRI());
deserialize_aspect([A, B], regular) -> {?BIN_TO_ATOM(A), B};
deserialize_aspect([<<"*">>, _], regular) -> throw(?new_ERROR_BAD_GRI());
deserialize_aspect([<<"*">>], regular) -> throw(?new_ERROR_BAD_GRI());
...
serialize_scope('*', regular) -> throw(?new_ERROR_BAD_GRI()).
...
deserialize_scope(<<"*">>, regular) -> throw(?new_ERROR_BAD_GRI());
deserialize_scope(_, _) -> throw(?new_ERROR_BAD_GRI()).

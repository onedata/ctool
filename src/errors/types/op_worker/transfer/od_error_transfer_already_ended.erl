...
to_json(?ERR_TRANSFER_ALREADY_ENDED(ErrorCtx)) ->
    #{
        <<"id">> => ?ERR_TRANSFER_ALREADY_ENDED_ID,
...
from_json(OdErrorJson = #{<<"id">> := ?ERR_TRANSFER_ALREADY_ENDED_ID}) ->
    ErrorCtxJson = maps:get(<<"ctx">>, OdErrorJson, #{}),
    ErrorCtx = od_error:ctx_from_json(ErrorCtxJson),
    ?ERR_TRANSFER_ALREADY_ENDED(ErrorCtx).

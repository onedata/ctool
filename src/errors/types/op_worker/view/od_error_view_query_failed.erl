...
to_json(?ERR_VIEW_QUERY_FAILED(ErrorCtx, Category, Description)) ->
    #{
        <<"id">> => ?ERR_VIEW_QUERY_FAILED_ID,
...
from_json(OdErrorJson = #{<<"id">> := ?ERR_VIEW_QUERY_FAILED_ID}) ->
    ...
    ?ERR_VIEW_QUERY_FAILED(ErrorCtx, Category, Description).

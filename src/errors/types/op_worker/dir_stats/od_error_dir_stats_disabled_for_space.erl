...
to_json(?ERR_DIR_STATS_DISABLED_FOR_SPACE(ErrorCtx)) ->
    #{
        <<"id">> => ?ERR_DIR_STATS_DISABLED_FOR_SPACE_ID,
...
from_json(OdErrorJson = #{<<"id">> := ?ERR_DIR_STATS_DISABLED_FOR_SPACE_ID}) ->
    ErrorCtxJson = maps:get(<<"ctx">>, OdErrorJson, #{}),
    ErrorCtx = od_error:ctx_from_json(ErrorCtxJson),
    ?ERR_DIR_STATS_DISABLED_FOR_SPACE(ErrorCtx).

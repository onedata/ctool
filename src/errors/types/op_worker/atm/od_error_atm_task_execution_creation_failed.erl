...
%%%-------------------------------------------------------------------
%%% @doc
%%% This module implements od_error for 'od_error_atm_task_execution_creation_failed'.
%%% @end
%%%-------------------------------------------------------------------
-module(od_error_atm_task_execution_creation_failed).
...
to_json(?ERROR_ATM_TASK_EXECUTION_CREATION_FAILED(AtmTaskSchemaId, SpecificError)) ->
...
from_json(OdErrorJson = #{<<"id">> := ?ERROR_ATM_TASK_EXECUTION_CREATION_FAILED_ID}) ->
    ...
    ?ERROR_ATM_TASK_EXECUTION_CREATION_FAILED(AtmTaskSchemaId, SpecificError).

...
to_json(?ERROR_ATM_TASK_EXECUTION_INITIATION_FAILED_MATCH(AtmTaskSchemaId, SpecificError)) ->
...
from_json(OdErrorJson = #{<<"id">> := ?ERROR_ATM_TASK_EXECUTION_INITIATION_FAILED_ID}) ->
    ...
    ?new_ERROR_ATM_TASK_EXECUTION_INITIATION_FAILED(AtmTaskSchemaId, SpecificError).

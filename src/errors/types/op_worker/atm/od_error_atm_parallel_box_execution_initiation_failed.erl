...
to_json(?ERROR_ATM_PARALLEL_BOX_EXECUTION_INITIATION_FAILED(AtmParallelBoxSchemaId, SpecificError)) ->
...
from_json(OdErrorJson = #{<<"id">> := ?ERROR_ATM_PARALLEL_BOX_EXECUTION_INITIATION_FAILED_ID}) ->
    ...
    ?ERROR_ATM_PARALLEL_BOX_EXECUTION_INITIATION_FAILED(AtmParallelBoxSchemaId, SpecificError).

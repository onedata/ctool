...
to_json(?ERR_ATM_LANE_EMPTY(ErrorCtx, AtmLaneSchemaId)) ->
    #{
        <<"id">> => ?ERR_ATM_LANE_EMPTY_ID,
...
from_json(OdErrorJson = #{<<"id">> := ?ERR_ATM_LANE_EMPTY_ID}) ->
    ...
    ?ERR_ATM_LANE_EMPTY(ErrorCtx, AtmLaneSchemaId).

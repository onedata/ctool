...
to_json(?ERR_ATM_STORE_NOT_FOUND(ErrorCtx, AtmStoreSchemaId)) ->
    #{
        <<"id">> => ?ERR_ATM_STORE_NOT_FOUND_ID,
...
from_json(OdErrorJson = #{<<"id">> := ?ERR_ATM_STORE_NOT_FOUND_ID}) ->
    ...
    ?ERR_ATM_STORE_NOT_FOUND(ErrorCtx, AtmStoreSchemaId).

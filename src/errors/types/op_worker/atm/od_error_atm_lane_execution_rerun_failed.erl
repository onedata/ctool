...
to_json(?ERR_ATM_LANE_EXECUTION_RERUN_FAILED(ErrorCtx)) ->
    #{
        <<"id">> => ?ERR_ATM_LANE_EXECUTION_RERUN_FAILED_ID,
...
from_json(OdErrorJson = #{<<"id">> := ?ERR_ATM_LANE_EXECUTION_RERUN_FAILED_ID}) ->
    ErrorCtxJson = maps:get(<<"ctx">>, OdErrorJson, #{}),
    ErrorCtx = od_error:ctx_from_json(ErrorCtxJson),
    ?ERR_ATM_LANE_EXECUTION_RERUN_FAILED(ErrorCtx).

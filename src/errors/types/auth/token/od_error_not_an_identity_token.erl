...
%%%-------------------------------------------------------------------
%%% @doc
%%% This module implements od_error for 'od_error_not_an_identity_token'.
%%% @end
%%%-------------------------------------------------------------------
...
from_json(OdErrorJson = #{<<"id">> := ?ERR_NOT_AN_IDENTITY_TOKEN_ID}) ->
    ...
    ?ERR_NOT_AN_IDENTITY_TOKEN(ErrorCtx, Received).

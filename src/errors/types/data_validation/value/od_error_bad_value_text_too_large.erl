...
to_json(?ERR_BAD_VALUE_TEXT_TOO_LARGE(ErrorCtx, Key, Limit)) ->
    #{
        <<"id">> => ?ERR_BAD_VALUE_TEXT_TOO_LARGE_ID,
...
from_json(OdErrorJson = #{<<"id">> := ?ERR_BAD_VALUE_TEXT_TOO_LARGE_ID}) ->
    ...
    ?ERR_BAD_VALUE_TEXT_TOO_LARGE(ErrorCtx, Key, Limit).

...
to_json(?ERR_NO_SERVICE_NODES(ErrorCtx, Service)) ->
    #{
        <<"id">> => ?ERR_NO_SERVICE_NODES_ID,
...
from_json(OdErrorJson = #{<<"id">> := ?ERR_NO_SERVICE_NODES_ID}) ->
    ...
    ?ERR_NO_SERVICE_NODES(ErrorCtx, Service).

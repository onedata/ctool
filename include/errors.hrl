...
-define(ERROR_LIMIT_REACHED(Limit, ErrnoresourceDescription), ?ERROR(?ERROR_LIMIT_REACHED_TYPE, {Limit, ErrnoresourceDescription})).
...
-define(ERROR_FORBIDDEN_FOR_CURRENT_ARCHIVE_STATE(AllowedStates, CurrentState), ?ERROR(?ERROR_FORBIDDEN_FOR_CURRENT_ARCHIVE_STATE_TYPE, {AllowedStates, CurrentState})).

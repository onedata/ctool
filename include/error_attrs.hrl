...
-define(ERR_NOT_SUPPORTED_FOR_SYMLINKS_ID, <<"notSupportedForSymlinks">>).
-define(ERR_NOT_SUPPORTED_FOR_SYMLINKS_TYPE, od_error_not_supported_for_symlinks).
...
-define(ERROR_ID_TO_TYPE_MAPPING, #{
    ...
    ?ERR_NOT_SUPPORTED_FOR_SYMLINKS_ID => ?ERR_NOT_SUPPORTED_FOR_SYMLINKS_TYPE,

...
testcases() -> [
    ...
    ?ERROR_ATM_LANE_EXECUTION_SETUP_FAILED(<<"id">>, ?ERROR_ATM_OPENFAAS_NOT_CONFIGURED),

    ?ERROR_ATM_PARALLEL_BOX_EMPTY(<<"id">>),
    ?ERROR_ATM_PARALLEL_BOX_EXECUTION_CREATION_FAILED(<<"id">>, ?ERROR_INTERNAL_SERVER_ERROR),
    ?ERROR_ATM_PARALLEL_BOX_EXECUTION_SETUP_FAILED(<<"id">>, ?ERROR_ATM_OPENFAAS_NOT_CONFIGURED),

    ?ERROR_ATM_TASK_EXECUTION_CREATION_FAILED(<<"id">>, ?ERROR_INTERNAL_SERVER_ERROR),
    ?ERROR_ATM_TASK_EXECUTION_SETUP_FAILED(<<"id">>, ?ERROR_ATM_OPENFAAS_NOT_CONFIGURED),
